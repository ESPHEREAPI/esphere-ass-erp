...
export class DashboardComponent implements OnInit {
  ...
  constructor(private adminLteService: AdminLteService, public dashboardService: DashboardService, private authService: AuthService, private cdr: ChangeDetectorRef) {
  ...
  // Filtres
  codeSouscripteur = ''; // À récupérer du contexte utilisateurFEICOM
  ...
  ngOnInit(): void {
      ...
      .subscribe((session: UserSession | null) => {
        ...
        if (dto) {
          ...
          this.codeSouscripteur = dto.lastname;
