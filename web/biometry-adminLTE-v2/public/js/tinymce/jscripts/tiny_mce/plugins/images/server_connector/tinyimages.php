...
class tinyimages {
	...
	public $folder = '';
	public $thumbs = '.mini';
	public  $originales = '.orig';
	
	function __construct() {
		define(DIR, $_SERVER['DOCUMENT_ROOT'].'/');
		$this->folder = $_SESSION ['USER_DIR'];
		
		// ATTENTION!
		// You need to check the session here, because methods of this class can be danger to security!
		// Ajoutez ici la s�curit� permettant de restreindre l'acc�s � l'explorateur
	...
	private function leftPanel() {
		...
		// Trie les donn�es par volume d�croissant, edition croissant
