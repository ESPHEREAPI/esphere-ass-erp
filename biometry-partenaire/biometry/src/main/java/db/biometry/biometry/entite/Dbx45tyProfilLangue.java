...
public class Dbx45tyProfilLangue implements Serializable {
    ...
    public Dbx45tyProfilLangue() {
    }

    public Dbx45tyProfilLangue(Integer id) {
        this.id = id;
    }

    public Dbx45tyProfilLangue(Integer id, String nom) {
        this.id = id;
        this.nom = nom;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Dbx45tyProfilLangue)) {
            return false;
        }
        Dbx45tyProfilLangue other = (Dbx45tyProfilLangue) object;
    ...
    public String toString() {
        return "db.biometry.biometry.entite.Dbx45tyProfilLangue[ id=" + id + " ]";
    }
