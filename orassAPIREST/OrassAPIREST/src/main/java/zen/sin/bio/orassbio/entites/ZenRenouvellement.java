...
//
//@NamedQueries({
//    @NamedQuery(name = "ZenRenouvellement.findAll", query = "SELECT z FROM ZenRenouvellement z")})
@Data
public class ZenRenouvellement implements Serializable {
